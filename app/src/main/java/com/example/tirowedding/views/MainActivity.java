...
public class MainActivity extends AppCompatActivity implements OfferItemAdapter.OfferClickedListeners {
    ...
    private void setUpList() {
        offerItemList.add(new OfferItem("New Year Seasonal", R.drawable.new1, 100000));
        offerItemList.add(new OfferItem("Military Offer", R.drawable.new2, 200000));
        offerItemList.add(new OfferItem("Christmas Offer", R.drawable.new3, 300000));
    }
